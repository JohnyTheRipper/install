...
sudo apt install plymouth plymouth-themes tmux gdebi openvpn firmware-linux gnome-shell-extension-manager gnome-shell-extension-manager flatpak gnome-software-plugin-flatpak
